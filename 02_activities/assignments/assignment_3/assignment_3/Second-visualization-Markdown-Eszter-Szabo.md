...
- For each visualization, describe and justify: 
    ...
    For the second visualization, I used Tableau Public.
    > Who is your intended audience? 
    My intended audience is the general public. 
    > What information or message are you trying to convey with your visualization? 
    The yearly trends of sales with a forecast for 2027.
    > What aspects of design did you consider when making your visualization? How did you apply them? With what elements of your plots? 
    I decided to display the yearly sales as a lineplot, showing the actual sums of sales counts for each year.
    > How did you ensure that your data visualizations are reproducible? If the tool you used to make your data visualization is not reproducible, how will this impact your data visualization? 
    I recognize that Tableau Public is less reproducible than scripted/Python approaches because it relies on a graphical interface and manual configuration. Also, as I only exported an image, for reproducibility, preserving the package workbook would be a better solution.
    ...
    The labour of the City of Toronto developers, the staff working at the ferry terminal, developers of Tableau Public software etc.
